...
class EmailTabsWidget extends StatelessWidget implements PreferredSizeWidget {
  final TabController tabController;
  final int selectedNavIndex;
  final List<EmailTabData> tabs;
  final List<EmailModel> emails;

  const EmailTabsWidget({
    Key? key,
      ...
      child: selectedNavIndex == 0
          ? SizedBox(
              ...
              child: TabBar(
                ...
                tabs: tabs.map((tab) {
                  final count = _getTabCount(tab.title);
  ...
  int _getTabCount(String tabTitle) {
    final db = DatabaseService();
    switch (tabTitle) {
      case 'All':
        return db.allEmailCount;
      case 'Unread':
        return db.unreadEmailCount;
      case 'Read':
        return db.readEmailCount;
      case 'Attachments':
        return db.attachmentEmailCount;
      default:
        return 0;
    }
  }
